...
By [Darshan](https://github.com/DarshanPawar17) | [LinkedIn](https://www.linkedin.com/in/darshan-jagdish-pawar-9b9701298/)
...
1. Paste `https://github.com/DarshanPawar17/repo` on the home page.
...
- **Grounded citations** rendered next to each answer, deep-linked to the
  exact line range on `github.com/DarshanPawar17/repo/blob/<branch>/<path>#L10-L35`.
...
```json
{ "repoUrl": "https://github.com/DarshanPawar17/repo", "force": false }
```
...
```json
{
  "repo": {
    "id": "65f...",
    "repoUrl": "https://github.com/DarshanPawar17/repo",
    "owner": "DarshanPawar17",
    "name": "repo",
    "defaultBranch": "main",
    "status": "ready",
